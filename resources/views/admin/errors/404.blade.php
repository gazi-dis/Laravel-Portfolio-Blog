...
<div class='pos-a t-0 l-0 bgc-white w-100 h-100 d-f fxd-r fxw-w ai-c jc-c pos-r p-30'>
    ...
    <div class='d-f jc-c fxd-c'>
        ...
        <h3 class='mB-10 fsz-lg c-grey-900 tt-c'>Oops! Sayfa Bulunamadı</h3>
        <p class='mB-30 fsz-def c-grey-700'>Aradığın sayfa yok veya kaldırılmış olabilir.</p>
        <div>
            <a href="/" type='primary' class='btn btn-primary'>Anasayfaya git</a>
        </div>
    </div>
</div>
</body>
